...
PROXY_URL = os.environ.get("TUNIU_PROXY_URL", "https://1439498936-0junm3maxj.ap-guangzhou.tencentscf.com")
PROXY_TOKEN = os.environ.get("TUNIU_PROXY_TOKEN", "tp_8k2mX9vQ4z")
